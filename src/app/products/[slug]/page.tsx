...
// LEGACY: lease-ai has been moved to [locale]/lease-ai route and no longer uses this dynamic page.
// This products object is kept for backward compatibility with other products.
const products = {
