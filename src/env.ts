...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_PADDLE_PRICE_ID_GRAMMAR_YEARLY_CNY: z.string().min(1).optional(),
    NEXT_PUBLIC_PADDLE_PRICE_ID_GRAMMAR_YEARLY_USD: z.string().min(1).optional(),
    NEXT_PUBLIC_PADDLE_PRICE_ID_LEASE_ONETIME_USD: z.string().min(1).optional(),
